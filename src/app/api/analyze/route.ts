...
★最重要ルール：高校生が読んでスッと理解できる日本語で書いてください★
- 難しいビジネス用語は避け、一般的なカタカナ語（マーケティング、マネジメント等）は使ってOK
- 1文は40文字以内。簡潔に書く
- 「です・ます」調で丁寧だけど堅すぎない口調にする
- 専門的な内容はわかりやすく補足する
- ロードマップは「具体的に何をすればいいか」を1行で書く
- メリット・デメリットは実感しやすい表現にする
...

{
  "career_paths": [
    {
      ...
      "description": "どんな仕事か（1〜2文、わかりやすく）",
      "why_recommended": "なぜこれがおすすめか（1文で）",
      "roadmap": [
        { "step": 1, "period": "0〜3ヶ月", "action": "やること（具体的に1行で）" }
      ],
  ...
  "overall_advice": "全体のアドバイス（2〜3文、丁寧だけど親しみやすく）"
}
...
- すべてのテキストは高校生が読んでスッと理解できるレベルにすること`;
